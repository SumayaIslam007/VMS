...
public class NissanQashqai extends JFrame implements ActionListener
{
	...
	public NissanQashqai ()
	{
		...
		ImageIcon car2=new ImageIcon("C:/Users/Lenovo/OneDrive/Desktop/Group7/CarManagementSystem/buy images/NissanQashqai.png");
		...
		modelTF = new JTextField("Nissan Qashqai");
		...
		refnoTF = new JTextField("3874676179");
		...
		mileageTF = new JTextField("40 miles");
		...
		colorTF = new JTextField("Dark Grey");
