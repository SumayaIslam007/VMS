...
public class RenaultClio extends JFrame implements ActionListener
{
	...
	public RenaultClio ()
	{
		...
		ImageIcon car2=new ImageIcon("C:/Users/Lenovo/OneDrive/Desktop/Group7/CarManagementSystem/buy images/RenaultClio.png");
		...
		refnoTF = new JTextField("3874676180");
		...
		mileageTF = new JTextField("19 miles");
