...
public class ChevroletCamaro extends JFrame implements ActionListener
{
	...
	public ChevroletCamaro ()
	{
		...
		nameTF = new JTextField("Camaro");
		nameTF.setBounds(175, 350, 100, 30);
		nameTF.setBackground(Color.WHITE);
		panel.add(nameTF);
		
		amountTF = new JTextField("$30,000");
		amountTF.setBounds(175, 400, 100, 30);
		amountTF.setBackground(Color.WHITE);
		panel.add(amountTF);
		
		modelTF = new JTextField("Chevrolet Camaro");
		...
		refnoTF = new JTextField("3874676160");
		...
		mileageTF = new JTextField("20 miles");
