...
public class ToyotaCrownAthlete extends JFrame implements ActionListener
{
	...
	public ToyotaCrownAthlete ()
	{
		...
		nameTF = new JTextField("Crown Athlete");
		...
		ImageIcon car2=new ImageIcon("C:/Users/Lenovo/OneDrive/Desktop/Group7/CarManagementSystem/buy images/ToyotaCrownAthlete.png");
		...
		amountTF = new JTextField("$25,000");
		amountTF.setBounds(175, 370, 100, 30);
		amountTF.setBackground(Color.WHITE);
		panel.add(amountTF);
		
		modelTF = new JTextField("Toyota Crown Athlete");
		...
		refnoTF = new JTextField("3874676183");
		...
		mileageTF = new JTextField("42 miles");
